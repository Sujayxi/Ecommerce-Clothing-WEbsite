...
?>
      ...
      <div class="card-header" style="background-color: white"><center><h3>Add Product</h3></center></div>
        ...
        <div class="card-body">
  <form role="form" method="post" action="insertproduct.php?action=add" enctype="multipart/form-data">
                            
                            <div class="form-group">
                              <input class="form-control" placeholder="Product Name" name="product" required autofocus="autofocus">
                            </div>
                            <div class="form-group">
                              <input type="hidden"  class="form-control" placeholder="Quantity" name="qntty">
                            </div> 
                            <div class="form-group">
                              <input type="text"  class="form-control" placeholder="Quantity" name="quantity" required>
                            </div> 
                             <div class="form-group">
                              <input type="text"  class="form-control" placeholder="Available" name="available" >
                            </div> 
                            <div class="form-group">
                            ...
                            <div class="form-group">
                            <label for="cakeimg">Cake Image:</label>
                            <input type="file" class="form-control-file"  id="cakeimg" name="cakeimg" required>
                            </div>
